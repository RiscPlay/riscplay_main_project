...
create_clock -name main_clock -period 13.468 -waveform {0 6.734} [get_nets {clk_from_pll}]
...
create_clock -name pixel_clock -period 13.468 -waveform {0 6.734} [get_nets {hdmi_inst/pix_clk}]
